...
public class PurescriptTyvarImpl extends ASTWrapperPsiElement implements PurescriptTyvar {

  public PurescriptTyvarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PurescriptVisitor) ((PurescriptVisitor)visitor).visitTyvar(this);
