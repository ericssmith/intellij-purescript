...
public class PurescriptGdpatImpl extends ASTWrapperPsiElement implements PurescriptGdpat {

  public PurescriptGdpatImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PurescriptVisitor) ((PurescriptVisitor)visitor).visitGdpat(this);
