...
public class PurescriptNewtypeconstrImpl extends ASTWrapperPsiElement implements PurescriptNewtypeconstr {

  public PurescriptNewtypeconstrImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PurescriptVisitor) ((PurescriptVisitor)visitor).visitNewtypeconstr(this);
