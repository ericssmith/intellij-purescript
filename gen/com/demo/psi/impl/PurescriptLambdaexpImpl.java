...
public class PurescriptLambdaexpImpl extends ASTWrapperPsiElement implements PurescriptLambdaexp {

  public PurescriptLambdaexpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PurescriptVisitor) ((PurescriptVisitor)visitor).visitLambdaexp(this);
